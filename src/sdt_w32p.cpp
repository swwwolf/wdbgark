...
// Windows 10 TH2 _W32pServiceTable
//////////////////////////////////////////////////////////////////////////
static const char* W32pServiceTable_Win10Th2_x64[] = {
    "NtUserGetOwnerTransformedMonitorRect",
    "NtUserYieldTask",
    "NtUserSetSensorPresence",
    "NtUserGetThreadState",
...
static const char** Service_Tables[][11] = {
    { KiServiceTable_XpSp3_x86,
      KiServiceTable_W2k3Sp2_x86,
      KiServiceTable_VistaSp0_x86, KiServiceTable_VistaSp1_x86, KiServiceTable_VistaSp2_x86,
      KiServiceTable_Win7Sp0_x86, KiServiceTable_Win7Sp1_x86,
      KiServiceTable_Win8Sp0_x86, KiServiceTable_Win8Sp1_x86,
      KiServiceTable_Win10Sp0_x86, KiServiceTable_Win10Th2_x86 },

    { nullptr, KiServiceTable_W2k3Sp2_x64,
      KiServiceTable_VistaSp0_x64, KiServiceTable_VistaSp1_x64, KiServiceTable_VistaSp2_x64,
      KiServiceTable_Win7Sp0_x64, KiServiceTable_Win7Sp1_x64,
      KiServiceTable_Win8Sp0_x64, KiServiceTable_Win8Sp1_x64,
      KiServiceTable_Win10Sp0_x64, KiServiceTable_Win10Th2_x64 },

    { W32pServiceTable_XpSp3_x86,
      W32pServiceTable_W2k3Sp2_x86,
      W32pServiceTable_VistaSp0_x86, W32pServiceTable_VistaSp1_x86, W32pServiceTable_VistaSp2_x86,
      W32pServiceTable_Win7Sp0_x86, W32pServiceTable_Win7Sp1_x86,
      W32pServiceTable_Win8Sp0_x86, W32pServiceTable_Win8Sp1_x86,
      W32pServiceTable_Win10Sp0_x86, W32pServiceTable_Win10Th2_x86 },

    { nullptr, W32pServiceTable_W2k3Sp2_x64,
      W32pServiceTable_VistaSp0_x64, W32pServiceTable_VistaSp1_x64, W32pServiceTable_VistaSp2_x64,
...
static const unsigned __int32 Service_Tables_countof[][11] = {
    { _countof(KiServiceTable_XpSp3_x86), _countof(KiServiceTable_W2k3Sp2_x86),
      ...
      _countof(KiServiceTable_Win10Sp0_x86), _countof(KiServiceTable_Win10Th2_x86) },
    ...
    { 0, _countof(KiServiceTable_W2k3Sp2_x64), _countof(KiServiceTable_VistaSp0_x64),
      ...
      _countof(KiServiceTable_Win10Sp0_x64), _countof(KiServiceTable_Win10Th2_x64) },
    ...
    { _countof(W32pServiceTable_XpSp3_x86), _countof(W32pServiceTable_W2k3Sp2_x86),
      ...
      _countof(W32pServiceTable_Win10Sp0_x86), _countof(W32pServiceTable_Win10Th2_x86) },
...
std::string get_service_table_routine_name(const unsigned __int32 minor_build,
    ...
    if ( minor_build <= WXP_VER ) {
        ...
        service_table = Service_Tables[type][ServiceTableXpSp3];
    } else if ( minor_build > WXP_VER && minor_build <= W2K3_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableW2k3Sp2];
        service_table = Service_Tables[type][ServiceTableW2k3Sp2];
    } else if ( minor_build > W2K3_VER && minor_build <= VISTA_RTM_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableVistaSp0];
        service_table = Service_Tables[type][ServiceTableVistaSp0];
    } else if ( minor_build > VISTA_RTM_VER && minor_build <= VISTA_SP1_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableVistaSp1];
        service_table = Service_Tables[type][ServiceTableVistaSp1];
    } else if ( minor_build > VISTA_SP1_VER && minor_build <= VISTA_SP2_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableVistaSp2];
        service_table = Service_Tables[type][ServiceTableVistaSp2];
    } else if ( minor_build > VISTA_SP2_VER && minor_build <= W7RTM_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableW7Sp0];
        service_table = Service_Tables[type][ServiceTableW7Sp0];
    } else if ( minor_build > W7RTM_VER && minor_build <= W7SP1_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableW7Sp1];
        service_table = Service_Tables[type][ServiceTableW7Sp1];
    } else if ( minor_build > W7SP1_VER && minor_build <= W8RTM_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableW8Sp0];
        service_table = Service_Tables[type][ServiceTableW8Sp0];
    } else if ( minor_build > W8RTM_VER && minor_build <= W81RTM_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableW8Sp1];
        service_table = Service_Tables[type][ServiceTableW8Sp1];
    } else if ( minor_build > W81RTM_VER && minor_build <= W10RTM_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableW10Sp0];
        service_table = Service_Tables[type][ServiceTableW10Sp0];
    } else if ( minor_build > W10RTM_VER && minor_build <= W10TH2_VER ) {
        max_count = Service_Tables_countof[type][ServiceTableW10Th2];
        service_table = Service_Tables[type][ServiceTableW10Th2];
    } else {
        return "*UNKNOWN*";
    }
